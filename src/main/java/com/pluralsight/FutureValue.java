...
public class FutureValue {
    ...
    public double userAnnualInterestRate(){
    ...
    public int userNumberOfTimesInterestCompoundedPerYear(){
    ...
    public int userNumberOfTimesMoneyInvestedInYear(){
    ...
    public double userCDEndingBalance(int principle, double annualInterestRate, int numberOfTimesMoneyInvestedInYear, int numberOfTimesInterestCompoundedPerYear){
