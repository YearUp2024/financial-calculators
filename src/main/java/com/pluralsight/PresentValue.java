...
public class PresentValue {
    ...
    public static int userMonthlyPayment(){
    ...
    public static double userMonthlyInterestRate(){
    ...
    public static int userNumberOfYear(){
    ...
    public static double userAmountNeedsToBeInvested(int monthlyPayment, double yearlyInterestRate, int numberOfYear){
